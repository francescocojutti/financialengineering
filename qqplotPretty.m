function h = qqplotPretty(varargin)
...
% ylabel(cax,ylab);
% title (cax,tlab);
xlabel('Standard Normal Quantiles','interpreter','latex','FontSize',13)
ylabel('Quantiles of Input Sample','interpreter','latex','FontSize',13)
title('QQ Plot of Sample Data vs Standard Normal','interpreter','latex','FontSize',16)
end
